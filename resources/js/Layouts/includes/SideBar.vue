    ...
    <div id="sidebar" class="app-sidebar bg-dark">
        ...
        >
            ...
            <div class="menu">
                ...
                <template v-if="user_logeado.tipo == 'PROFESOR'">
                    <div class="menu-item has-sub">
                        ...
                        <div class="menu-submenu">
                            <div
                                class="menu-item"
                                :class="[
                                    route_current == 'aprendizajes.index'
                                        ? 'active'
                                        : '',
                                ]"
                            >
                                <Link
                                    :href="route('aprendizajes.index')"
                                    class="menu-link"
                                    ><div class="menu-text">Jugar</div></Link
                                >
                                <Link
                ...
                <template v-else>
                    <div
                        v-if="
                            user_logeado.permisos.includes('aprendizajes.index')
                        "
                        class="menu-item"
                        :class="[
                            route_current == 'aprendizajes.index'
                ...
                <div
                    ...
                    class="menu-item"
                    :class="[
                        route_current == 'evaluacions.edit' ? 'active' : '',
                    ]"
                >
                    <Link :href="route('evaluacions.edit')" class="menu-link">
                        <div class="menu-icon">
                            <i class="fa fa-clipboard-list"></i>
                        </div>
                        <div class="menu-text">Evaluación</div>
                    </Link>
                </div>
                <div
                    v-if="user_logeado.permisos.includes('evaluacions.index')"
                    class="menu-item"
                    :class="[
                        route_current == 'evaluacions.index' ? 'active' : '',
                    ]"
                >
                    <Link :href="route('evaluacions.index')" class="menu-link">
                        <div class="menu-icon">
                ...
                <div
                    v-if="user_logeado.permisos.includes('materials.index')"
                    class="menu-item"
                    :class="[
                        route_current == 'materials.index' ? 'active' : '',
                    ]"
                >
                    <Link :href="route('materials.index')" class="menu-link">
                        ...
                        <div class="menu-text">Materiales de Apoyo</div>
                    </Link>
                </div>
                <div
                    v-if="user_logeado.permisos.includes('cursos.index')"
                    class="menu-item"
                    :class="[route_current == 'cursos.index' ? 'active' : '']"
                >
                    <Link :href="route('cursos.index')" class="menu-link">
                        <div class="menu-icon">
